...
### travel（旅行）
優先: なぜ旅行したいか（動機）> 誰と > いつ > 予算
例: 「旅行したい」→「どんな気分でお出かけしたいですか？😊 ゆっくり癒されたい・アクティブに観光したい・美食を楽しみたいなど、気分を教えてもらえると理想のプランを提案できます！」
例: 「どこかに行きたい」→「一人で行く予定ですか？それとも誰かと一緒ですか？旅のスタイルによっておすすめが変わります✈️」
...
_QUICK_PROPOSE_PATTERNS = {
    "travel":    ["行き先", "旅行先", "どこ", "温泉", "観光", "ホテル", "泊", "沖縄", "京都", "海外"],
